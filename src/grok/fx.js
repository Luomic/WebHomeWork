...
export const Re0 = 114.2705;
export const STAR_COLOR = "#f4c34e";
export const PALETTE = ["#f9705c", "#5b95f0", "#3fbe86", "#f5b13f", "#9a72ee", "#35c3bd"];
export const STAR = (() => {
  const n = [];
  for (let e = 0; e < 10; e++) {
...
export const CYCLE = new Set(["progress", "spawning"]);
export const CYCLE_ON = { progress: 2500, spawning: 2000 };
...
export const DOT_R = 22;
export const DOT_GAP = 62;
export const POP0 = 0.84;
export const POP1 = 0.22;
export const SEND_MS = 1500;
export const RECV_MS = 1700;
export const PENCIL_MS = 2500;
...
export function rotateRing(n, e, R) {
...
export function lerpRing(a, b, t) {
...
export function pencilPose(now, stateAt) {
...
export const turnAtCache = new Map();
export function turnAtOf(name, path, R) {
  if (turnAtCache.has(name)) return turnAtCache.get(name);
  const solid = GROK_GEO.solids?.[name];
  if (!solid || !makeTurnAt) {
...
export const beltCache = new Map();
export function beltRadius(path, R) {
...
export function shapeMetrics(shape, R) {
  return {
    face: shape.face,
