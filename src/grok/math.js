...
export function flattenPath(d, e = 4) {
...
export function buildSpan(pts, Re, e = 160) {
...
export const spanCache = new Map();
export function spanAt(path, Re) {
  const key = path;
